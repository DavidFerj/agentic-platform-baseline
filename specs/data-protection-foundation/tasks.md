# Data protection foundation tasks

- [x] DPF-TASK-001: define requirements and acceptance criteria.
- [x] DPF-TASK-002: add deterministic domain entities and engine.
- [x] DPF-TASK-003: add versioned closed evidence contract.
- [x] DPF-TASK-004: add control catalog, applicability matrix, and processing inventory.
